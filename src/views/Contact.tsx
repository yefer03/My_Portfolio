// assets
import contactIllustration from "../assets/figura3.svg";
      ...
      <div className="max-w-screen-2xl flex flex-col xl:flex-row xl:justify-between items-center xl:items-start gap-12 w-full pt-20 pb-20 sm:pb-16 px-12">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <motion.img
            ...
            whileInView="visible"
            viewport={{ once: false }}
            src={contactIllustration} alt="" className="max-h-[320px]"
          />
        </div>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: false }}
          className="flex-1 flex flex-col gap-6 w-full max-w-[690px]"
        >
